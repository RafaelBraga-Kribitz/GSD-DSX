...
DSX-CRV-010 fixture: the frontmatter `schema` tag below is `dsx-chart-review-v0`, not the
contract identity `dsx-chart-review-v1` — the only defect this fixture is meant to exercise.
Every other structural rule stays conformant.
...
**Justification:** Fixture isolates the schema-tag defect only.
