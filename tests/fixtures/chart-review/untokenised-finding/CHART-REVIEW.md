...
DSX-CRV-013 fixture: one Moderate Issues bullet below cites neither a `DSX-` code nor
`UNMAPPED` — the only defect this fixture is meant to exercise. Every other structural rule
stays conformant.
...
- [COMMUNICATION] the y-axis does not start at zero, exaggerating the visual slope
...
8. Plot Construction: rebase the y-axis at zero or add a visible break.
...
**Decision-table row:** Any Critical Visual/Communication or Moderate Analytical/Data/Code/
Statistical -> ApprovedWithRevisions.

**Justification:** Fixture isolates the untokenised-finding-line defect only.
