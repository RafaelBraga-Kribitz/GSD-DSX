...
**Approval:** verified (technical) 2026-08-29 — gate **SECURED**, `threats_open: 0`, 23/23 closed by orchestrator re-gate. **Human sign-off granted 2026-08-29 (operator verdict recorded in HUMAN-QUEUE.md, item HQ-14):** the sign-off line above is approved as written. REQ-P15-04 is confirmed **PARTIAL by design** per the HQ-8 D-05 citation decision — the CUPED and changing-denominator citations were confirmed by direct primary-source read (Deng/Xu/Kohavi/Walker 2013; Crook/Frasca/Kohavi/Longbotham 2009 "Pitfall 4") and ship; the survivorship-bias citation (Brown/Goetzmann/Ibbotson/Ross 1992) was found not to transfer to the needed rule and stays unshipped — an honest partial satisfaction, not a silent scope-narrowing. The D-06 numbering veto for the two new codes is granted separately per HQ-13 (accepted HIGH severity for `DSX-MET-021`, accepted CRITICAL severity for `DSX-EXP-070`). Phase 15 is now both technically verified and human-approved.
