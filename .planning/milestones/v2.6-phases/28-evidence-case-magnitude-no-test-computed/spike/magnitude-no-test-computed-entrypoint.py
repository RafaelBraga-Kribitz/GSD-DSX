# Paired entrypoint for magnitude-no-test-computed-ANALYSIS-SPEC.yaml (Phase 28 spike).
# Nothing here is ever executed by the gate: the entrypoint check (dsx/checks/code.py)
# reads it as text; the reproducibility check (DSX-REP-030/031) tests only that the
# declared path resolves. No CSV is required.
#
