...
- **12-03** ✅ executed (wave 2, deps [12-01]) — REQ-P12-02: sidecar validation — closed catalogue∪backlog union sibling-integrity + live falsifiability across all four gate points (hypothetical code ⇒ miss).
